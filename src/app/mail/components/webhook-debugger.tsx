        ...
        <DialogHeader>
          ...
          <DialogDescription>
            {data?.records?.map((record) => (
              <div key={record.id} className="mb-4 rounded-md bg-slate-100 p-4">
                <div className="mb-2">
                ...
                {record.failSince && (
                  <div className="mb-2">
                    <span className="font-semibold">Failing since:</span>{" "}
                    {record.failSince}
                  </div>
                )}
                {record.failDescription && (
                  <div className="mb-2">
                    <span className="font-semibold">Fail reason:</span>{" "}
                    {record.failDescription}
                  </div>
                )}
                <Button
